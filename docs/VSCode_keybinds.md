...
1) [Text editor](#text-editor)
    ...
    1.2) [Insert](#insert)
    1.3) [Delete](#delete)
    1.4) [Bookmarks](#bookmarks)
    1.5) [Textmarker](#textmarker)
    1.6) [Groups](#groups)
    1.7) [Problems](#problems)
    1.8) [Suggestions](#suggestions)
    1.9) [References](#references)
    1.10) [Definitions](#definitions)
    1.11) [Refactorization](#refactorization)
2) [Lists](#lists)
3) [Search](#search)
4) [Terminal](#terminal)
5) [Panel](#panel)
